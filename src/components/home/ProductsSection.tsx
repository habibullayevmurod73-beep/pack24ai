...
import { getProductUI } from '@/lib/product-translations';
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h2 className="text-2xl font-extrabold text-gray-900">
                        {getProductUI('popular', language)}
                    </h2>
                    <p className="text-sm text-gray-500 mt-1">
                        {getProductUI('popularSub', language)}
                    </p>
                </div>
                <Link
                    href="/catalog"
                ...
                >
                    {getProductUI('viewAll', language)} <ChevronRight size={16} />
                </Link>
            </div>
            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="mt-6 text-center sm:hidden">
                        ...
                        >
                            {getProductUI('viewAll', language)} <ArrowRight size={15} />
                        </Link>
                    </div>
                </>
            )}
